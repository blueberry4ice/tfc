...
class TourpackageComponent extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        // $this->bycategory = implode(",", array_filter($this->listcategory));
            ...
            $query = "(
                ...
                6 AS category, agents.id as agent_id, tourpackages.dept_month, tourpackages.country
        ...
        return view(
            'livewire.tourpackage-component',
            [
                'products' => $products
                    // ->distinct(['id', 'sku', 'name', 'summary', 'price', 'thumbnail', 'category'])
                    ->paginate(9),
