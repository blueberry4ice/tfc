...
class CrudVisa extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.crud-visa', ['products' => $products, 'dataAgents' => $dataAgents, 'dataMonths' => $dataMonths])->layout('layouts.base');
    }
    ...
    public function store()
    {
        ...
        DB::table('agent_visa')->where('id_package', $this->productid)->delete();
    ...
    public function edit($id, $isedit)
    {
        ...
        $this->resetErrorBag();
        $this->isedit = $isedit;
        $product = Visa::findOrFail($id);
        $agents = Agentvisa::where('id_package', $id)->get();
