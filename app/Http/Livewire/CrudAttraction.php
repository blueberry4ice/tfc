...
public $isedit;
    ...
    {
        $products = Attraction::orderBy("id", "desc")->paginate(10);
        $dataAgents = Agent::all();
        $dataMonths = Month::all();
        return view('livewire.crud-attraction', ['products' => $products, 'dataAgents' => $dataAgents, 'dataMonths' => $dataMonths])->layout('layouts.base');
    }
    ...
    public function store()
    {
        ...
        DB::table('agent_attractions')->where('id_package', $this->productid)->delete();
    ...
    {
        Attraction::find($this->deleteId)->delete();
