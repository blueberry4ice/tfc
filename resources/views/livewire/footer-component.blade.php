            ...
            <div class="partner-wrapper">
                {{-- <div class="partner-list partner-group" style=" width: 100%;">
                    <div class="partner-logo" style="display: flex;">
                        <img src="{{ asset('assets/img/astindo.png') }}" alt="" class="ic_astindo lazy">
                        <a target="_blank" href="https://www.astindovirtualtravelfair.com/" class="img-href">
                            <img src="{{ asset('assets/img/logo-astindo-white.png') }}" alt="logo-color" class="lazy" >
                        </a>
                        <img src="{{ asset('assets/img/kemenhub.png') }}" alt="" class="ic_kemenhub lazy">
                        <img src="{{ asset('assets/img/wonderfull_black.png') }}" alt="" class="ic_wonder lazy">
                        <img src="{{ asset('assets/img/baparekraf.png') }}" alt="" class="ic_baprek lazy">
                    </div>
                </div> --}}
                ...
                <div class="partner-list">
                    ...
                    <div class="partner-logo">
                        <a href="https://www.bca.co.id/en/Individu" target="_blank"><img src="{{ asset('assets/img/5-bank.png') }}" alt="" style="max-width: 75%" class="lazy"> </a>
                    </div>
                </div>
                <div class="partner-list">
                    <div class="bold fz12 partner-name">Insurance Partner</div>
                    <div class="partner-logo">
                        <a href="https://www.bcainsurance.co.id/" target="_blank" style="height: 78px; display: flex; align-items: center"><img src="{{ asset('assets/img/logo bcai-01.png') }}" alt="" class="lazy"></a>
                    </div>
                </div>
                <div class="partner-list">
                ...
                <div class="partner-list partner-group">
                    ...
                    <div class="partner-logo" style="display: flex;">
                        ...
                        <img src="{{ asset('assets/img/airlines/ek.png') }}" alt=""
                            class="ic_sq lazy">
                        <img src="{{ asset('assets/img/airlines/ey.png') }}" alt="" class="ic_sq lazy">
                    </div>
                    <div class="partner-logo" style="display: flex;">
