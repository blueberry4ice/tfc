            ...
            <div class="partner-wrapper">
                {{-- <div class="partner-list partner-group" style=" width: 100%;">
                    <div class="partner-logo" style="display: flex;">
                        <img data-src="{{ asset('assets/img/astindo.png') }}" alt="" class="ic_astindo lazy">
                        <a target="_blank" href="https://www.astindovirtualtravelfair.com/" class="img-href">
                            <img data-src="{{ asset('assets/img/logo-astindo-white.png') }}" alt="logo-color" class="lazy" >
                        </a>
                        <img data-src="{{ asset('assets/img/kemenhub.png') }}" alt="" class="ic_kemenhub lazy">
                        <img data-src="{{ asset('assets/img/wonderfull_black.png') }}" alt="" class="ic_wonder lazy">
                        <img data-src="{{ asset('assets/img/baparekraf.png') }}" alt="" class="ic_baprek lazy">
                    </div>
                </div> --}}
                ...
                <div class="partner-list">
                    ...
                    <div class="partner-logo">
                        <a href="https://www.bca.co.id/en/Individu" target="_blank"><img data-src="{{ asset('assets/img/5-bank.png') }}" alt="" style="max-width: 75%" class="lazy"> </a>
                    </div>
                </div>
                <div class="partner-list">
                    <div class="bold fz12 partner-name">Insurance Partner</div>
                    <div class="partner-logo">
                        <a href="https://www.bcainsurance.co.id/" target="_blank" style="height: 78px; display: flex; align-items: center"><img data-src="{{ asset('assets/img/logo bcai-01.png') }}" alt="" class="lazy"></a>
                    </div>
                </div>
                <div class="partner-list">
                    <div class="bold fz12 partner-name">Telecommunication Partner</div>
                    <div class="partner-logo">
                        <a href="https://www.telkomsel.com/" target="_blank"><img data-src="{{ asset('assets/img/telkomsel.png') }}" alt="" style="max-width: 80%" class="lazy"></a>
                    </div>
                </div>
                <div class="partner-list partner-group partner-tech">
                    ...
                    <div class="partner-logo">
                        <a target="_blank" class="img-nto" href="http://www.travelportindonesia.com" style="width: 33.3334%">
                            <img data-src="{{ asset('assets/img/galileo.png') }}" alt="" class="lazy" style="padding: 0;">
                        </a>
                        <a target="_blank" class="img-nto" href="https://atibusinessgroup.com/" style="width: 33.3334%">
                            <img data-src="{{ asset('assets/img/logo-ati.png') }}" class="lazy" style="width: 50%" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-list partner-group">
                    ...
                    <div class="partner-logo" style="display: flex;">
                        <img data-src="{{ asset('assets/img/airlines/ana.png') }}" alt="" class="ic_sq lazy">
                        <img data-src="{{ asset('assets/img/airlines/cathaypacific_master-logo_vertical_green_en.png') }}"
                            alt="" class="ic_sq lazy">
                        <img data-src="{{ asset('assets/img/airlines/Logo type Citilink-01 hijau.png') }}" alt=""
                            class="ic_sq lazy">
                        <img data-src="{{ asset('assets/img/airlines/01 Intl-Sig-SkyTeam-4C.jpg') }}" alt=""
                            class="ic_sq" class="lazy" style="max-width: 40%">
                        <img data-src="{{ asset('assets/img/airlines/ek.png') }}" alt=""
                            class="ic_sq lazy">
                        <img data-src="{{ asset('assets/img/airlines/ey.png') }}" alt="" class="ic_sq lazy">
                    </div>
                    <div class="partner-logo" style="display: flex;">
                        ...
                        <img data-src="{{ asset('assets/img/airlines/MH_Logo.png') }}" alt=""
                            class="ic_sq lazy" style="width: 35%">
                        <img data-src="{{ asset('assets/img/airlines/PAS_Logo_Final_220107.png') }}" alt=""
                            class="ic_sq lazy" style="width: 35%">
                        <img data-src="{{ asset('assets/img/airlines/4-Star PAL logo 2-liner W-01.png') }}" alt=""
                            class="ic_sq lazy" style="width: 35%">
                    </div>
                    <div class="partner-logo" style="display: flex;">
                ...
                <div class="partner-list partner-group partner-support">
                    ...
                    <div class="partner-logo">
                        <a target="_blank" class="support1" href="https://dinaskebudayaan.jakarta.go.id/">
                            <img data-src="{{ asset('assets/img/dinas.png') }}" class="lazy" style="max-width: 65%" alt="">
                        </a>
                        <a target="_blank" class="support2" href="https://www.jakarta-tourism.go.id/">
                            <img data-src="{{ asset('assets/img/enjoy jakarta.png') }}" class="lazy" style="max-width: 75%" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-list partner-venue">
                    ...
                    <div class="partner-logo">
                        <a href="https://pikavenue.com" target="_blank">
                            <img data-src="{{ asset('assets/img/pik.jpg') }}" alt="" class="lazy" style="max-width: 50%"> 
                        </a>
                    </div>
                </div>
                <div class="partner-list partner-venue">
